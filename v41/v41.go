...
const (
	...
	NFS4ERR_BADIOMODE = 10049 // NFS4ERR_BADIOMODE
	NFS4ERR_BADLAYOUT = 10050 // NFS4ERR_BADLAYOUT
	NFS4ERR_BAD_SESSION_DIGEST = 10051 // NFS4ERR_BAD_SESSION_DIGEST
	NFS4ERR_BADSESSION = 10052 // NFS4ERR_BADSESSION
	NFS4ERR_BADSLOT = 10053 // NFS4ERR_BADSLOT
	NFS4ERR_COMPLETE_ALREADY = 10054 // NFS4ERR_COMPLETE_ALREADY
	NFS4ERR_CONN_NOT_BOUND_TO_SESSION = 10055 // NFS4ERR_CONN_NOT_BOUND_TO_SESSION
	NFS4ERR_DELEG_ALREADY_WANTED = 10056 // NFS4ERR_DELEG_ALREADY_WANTED
	NFS4ERR_BACK_CHAN_BUSY = 10057 // NFS4ERR_BACK_CHAN_BUSY
	NFS4ERR_LAYOUTTRYLATER = 10058 // NFS4ERR_LAYOUTTRYLATER
	NFS4ERR_LAYOUTUNAVAILABLE = 10059 // NFS4ERR_LAYOUTUNAVAILABLE
	NFS4ERR_NOMATCHING_LAYOUT = 10060 // NFS4ERR_NOMATCHING_LAYOUT
	NFS4ERR_RECALLCONFLICT = 10061 // NFS4ERR_RECALLCONFLICT
	NFS4ERR_UNKNOWN_LAYOUTTYPE = 10062 // NFS4ERR_UNKNOWN_LAYOUTTYPE
	NFS4ERR_SEQ_MISORDERED = 10063 // NFS4ERR_SEQ_MISORDERED
	NFS4ERR_SEQUENCE_POS = 10064 // NFS4ERR_SEQUENCE_POS
	NFS4ERR_REQ_TOO_BIG = 10065 // NFS4ERR_REQ_TOO_BIG
	NFS4ERR_REP_TOO_BIG = 10066 // NFS4ERR_REP_TOO_BIG
	NFS4ERR_REP_TOO_BIG_TO_CACHE = 10067 // NFS4ERR_REP_TOO_BIG_TO_CACHE
	NFS4ERR_RETRY_UNCACHED_REP = 10068 // NFS4ERR_RETRY_UNCACHED_REP
	NFS4ERR_UNSAFE_COMPOUND = 10069 // NFS4ERR_UNSAFE_COMPOUND
	NFS4ERR_TOO_MANY_OPS = 10070 // NFS4ERR_TOO_MANY_OPS
	NFS4ERR_OP_NOT_IN_SESSION = 10071 // NFS4ERR_OP_NOT_IN_SESSION
	NFS4ERR_HASH_ALG_UNSUPP = 10072 // NFS4ERR_HASH_ALG_UNSUPP
	NFS4ERR_CLIENTID_BUSY = 10074 // NFS4ERR_CLIENTID_BUSY
	NFS4ERR_PNFS_IO_HOLE = 10075 // NFS4ERR_PNFS_IO_HOLE
	NFS4ERR_SEQ_FALSE_RETRY = 10076 // NFS4ERR_SEQ_FALSE_RETRY
	NFS4ERR_BAD_HIGH_SLOT = 10077 // NFS4ERR_BAD_HIGH_SLOT
	NFS4ERR_DEADSESSION = 10078 // NFS4ERR_DEADSESSION
	NFS4ERR_ENCR_ALG_UNSUPP = 10079 // NFS4ERR_ENCR_ALG_UNSUPP
	NFS4ERR_PNFS_NO_LAYOUT = 10080 // NFS4ERR_PNFS_NO_LAYOUT
	NFS4ERR_NOT_ONLY_OP = 10081 // NFS4ERR_NOT_ONLY_OP
	NFS4ERR_WRONG_CRED = 10082 // NFS4ERR_WRONG_CRED
	NFS4ERR_WRONG_TYPE = 10083 // NFS4ERR_WRONG_TYPE
	NFS4ERR_DIRDELEG_UNAVAIL = 10084 // NFS4ERR_DIRDELEG_UNAVAIL
	NFS4ERR_REJECT_DELEG = 10085 // NFS4ERR_REJECT_DELEG
	NFS4ERR_RETURNCONFLICT = 10086 // NFS4ERR_RETURNCONFLICT
	NFS4ERR_DELEG_REVOKED = 10087 // NFS4ERR_DELEG_REVOKED
	...
	LAYOUTIOMODE4_READ = 1 // LAYOUTIOMODE4_READ
	LAYOUTIOMODE4_RW = 2 // LAYOUTIOMODE4_RW
	LAYOUTIOMODE4_ANY = 3 // LAYOUTIOMODE4_ANY
	LAYOUTRETURN4_FILE = 1 // LAYOUTRETURN4_FILE
	LAYOUTRETURN4_FSID = 2 // LAYOUTRETURN4_FSID
	LAYOUTRETURN4_ALL = 3 // LAYOUTRETURN4_ALL
	STATUS4_FIXED = 1 // STATUS4_FIXED
	STATUS4_UPDATED = 2 // STATUS4_UPDATED
	STATUS4_VERSIONED = 3 // STATUS4_VERSIONED
	STATUS4_WRITABLE = 4 // STATUS4_WRITABLE
	STATUS4_REFERRAL = 5 // STATUS4_REFERRAL
	READ_LT = 1 // READ_LT
	WRITE_LT = 2 // WRITE_LT
	READW_LT = 3 // READW_LT
	WRITEW_LT = 4 // WRITEW_LT
	SSV4_SUBKEY_MIC_I2T = 1 // SSV4_SUBKEY_MIC_I2T
	SSV4_SUBKEY_MIC_T2I = 2 // SSV4_SUBKEY_MIC_T2I
	SSV4_SUBKEY_SEAL_I2T = 3 // SSV4_SUBKEY_SEAL_I2T
	SSV4_SUBKEY_SEAL_T2I = 4 // SSV4_SUBKEY_SEAL_T2I
	NFLH4_CARE_DENSE = 1 // NFLH4_CARE_DENSE
	NFLH4_CARE_COMMIT_THRU_MDS = 2 // NFLH4_CARE_COMMIT_THRU_MDS
	NFLH4_CARE_STRIPE_UNIT_SIZE = 64 // NFLH4_CARE_STRIPE_UNIT_SIZE
	NFLH4_CARE_STRIPE_COUNT = 128 // NFLH4_CARE_STRIPE_COUNT
	UNCHECKED4 = 0 // UNCHECKED4
	GUARDED4 = 1 // GUARDED4
	EXCLUSIVE4 = 2 // EXCLUSIVE4
	EXCLUSIVE4_1 = 3 // EXCLUSIVE4_1
	...
	OPEN_DELEGATE_NONE_EXT = 3 // OPEN_DELEGATE_NONE_EXT
	...
	CLAIM_FH = 4 // CLAIM_FH
	CLAIM_DELEG_CUR_FH = 5 // CLAIM_DELEG_CUR_FH
	CLAIM_DELEG_PREV_FH = 6 // CLAIM_DELEG_PREV_FH
	WND4_NOT_WANTED = 0 // WND4_NOT_WANTED
	WND4_CONTENTION = 1 // WND4_CONTENTION
	WND4_RESOURCE = 2 // WND4_RESOURCE
	WND4_NOT_SUPP_FTYPE = 3 // WND4_NOT_SUPP_FTYPE
	WND4_WRITE_DELEG_NOT_SUPP_FTYPE = 4 // WND4_WRITE_DELEG_NOT_SUPP_FTYPE
	WND4_NOT_SUPP_UPGRADE = 5 // WND4_NOT_SUPP_UPGRADE
	WND4_NOT_SUPP_DOWNGRADE = 6 // WND4_NOT_SUPP_DOWNGRADE
	WND4_CANCELLED = 7 // WND4_CANCELLED
	WND4_IS_DIR = 8 // WND4_IS_DIR
	...
	CDFC4_FORE = 1 // CDFC4_FORE
	CDFC4_BACK = 2 // CDFC4_BACK
	CDFC4_FORE_OR_BOTH = 3 // CDFC4_FORE_OR_BOTH
	CDFC4_BACK_OR_BOTH = 7 // CDFC4_BACK_OR_BOTH
	CDFS4_FORE = 1 // CDFS4_FORE
	CDFS4_BACK = 2 // CDFS4_BACK
	CDFS4_BOTH = 3 // CDFS4_BOTH
	SP4_NONE = 0 // SP4_NONE
	SP4_MACH_CRED = 1 // SP4_MACH_CRED
	SP4_SSV = 2 // SP4_SSV
	GDD4_OK = 0 // GDD4_OK
	GDD4_UNAVAIL = 1 // GDD4_UNAVAIL
	SECINFO_STYLE4_CURRENT_FH = 0 // SECINFO_STYLE4_CURRENT_FH
	SECINFO_STYLE4_PARENT = 1 // SECINFO_STYLE4_PARENT
	...
	OP_BACKCHANNEL_CTL = 40 // OP_BACKCHANNEL_CTL
	OP_BIND_CONN_TO_SESSION = 41 // OP_BIND_CONN_TO_SESSION
	OP_EXCHANGE_ID = 42 // OP_EXCHANGE_ID
	OP_CREATE_SESSION = 43 // OP_CREATE_SESSION
	OP_DESTROY_SESSION = 44 // OP_DESTROY_SESSION
	OP_FREE_STATEID = 45 // OP_FREE_STATEID
	OP_GET_DIR_DELEGATION = 46 // OP_GET_DIR_DELEGATION
	OP_GETDEVICEINFO = 47 // OP_GETDEVICEINFO
	OP_GETDEVICELIST = 48 // OP_GETDEVICELIST
	OP_LAYOUTCOMMIT = 49 // OP_LAYOUTCOMMIT
	OP_LAYOUTGET = 50 // OP_LAYOUTGET
	OP_LAYOUTRETURN = 51 // OP_LAYOUTRETURN
	OP_SECINFO_NO_NAME = 52 // OP_SECINFO_NO_NAME
	OP_SEQUENCE = 53 // OP_SEQUENCE
	OP_SET_SSV = 54 // OP_SET_SSV
	OP_TEST_STATEID = 55 // OP_TEST_STATEID
	OP_WANT_DELEGATION = 56 // OP_WANT_DELEGATION
	OP_DESTROY_CLIENTID = 57 // OP_DESTROY_CLIENTID
	OP_RECLAIM_COMPLETE = 58 // OP_RECLAIM_COMPLETE
	OP_ILLEGAL = 10044 // OP_ILLEGAL
	LAYOUTRECALL4_FILE = 1 // LAYOUTRECALL4_FILE
	LAYOUTRECALL4_FSID = 2 // LAYOUTRECALL4_FSID
	LAYOUTRECALL4_ALL = 3 // LAYOUTRECALL4_ALL
	NOTIFY4_CHANGE_CHILD_ATTRS = 0 // NOTIFY4_CHANGE_CHILD_ATTRS
	NOTIFY4_CHANGE_DIR_ATTRS = 1 // NOTIFY4_CHANGE_DIR_ATTRS
	NOTIFY4_REMOVE_ENTRY = 2 // NOTIFY4_REMOVE_ENTRY
	NOTIFY4_ADD_ENTRY = 3 // NOTIFY4_ADD_ENTRY
	NOTIFY4_RENAME_ENTRY = 4 // NOTIFY4_RENAME_ENTRY
	NOTIFY4_CHANGE_COOKIE_VERIFIER = 5 // NOTIFY4_CHANGE_COOKIE_VERIFIER
	...
	OP_CB_LAYOUTRECALL = 5 // OP_CB_LAYOUTRECALL
	OP_CB_NOTIFY = 6 // OP_CB_NOTIFY
	OP_CB_PUSH_DELEG = 7 // OP_CB_PUSH_DELEG
	OP_CB_RECALL_ANY = 8 // OP_CB_RECALL_ANY
	OP_CB_RECALLABLE_OBJ_AVAIL = 9 // OP_CB_RECALLABLE_OBJ_AVAIL
	OP_CB_RECALL_SLOT = 10 // OP_CB_RECALL_SLOT
	OP_CB_SEQUENCE = 11 // OP_CB_SEQUENCE
	OP_CB_WANTS_CANCELLED = 12 // OP_CB_WANTS_CANCELLED
	OP_CB_NOTIFY_LOCK = 13 // OP_CB_NOTIFY_LOCK
	OP_CB_NOTIFY_DEVICEID = 14 // OP_CB_NOTIFY_DEVICEID
	...
	NFS4_SESSIONID_SIZE = 16 // NFS4_SESSIONID_SIZE
	...
	NFS4_MAXFILELEN = 0xffffffffffffffff // NFS4_MAXFILELEN
	NFS4_MAXFILEOFF = 0xfffffffffffffffe // NFS4_MAXFILEOFF
	...
	ACE4_INHERITED_ACE = 0x00000080 // ACE4_INHERITED_ACE
	...
	ACE4_WRITE_RETENTION = 0x00000200 // ACE4_WRITE_RETENTION
	ACE4_WRITE_RETENTION_HOLD = 0x00000400 // ACE4_WRITE_RETENTION_HOLD
	...
	ACL4_AUTO_INHERIT = 0x00000001 // ACL4_AUTO_INHERIT
	ACL4_PROTECTED = 0x00000002 // ACL4_PROTECTED
	ACL4_DEFAULTED = 0x00000004 // ACL4_DEFAULTED
	...
	NFS4_DEVICEID4_SIZE = 16 // NFS4_DEVICEID4_SIZE
	LAYOUT4_RET_REC_FILE = 1 // LAYOUT4_RET_REC_FILE
	LAYOUT4_RET_REC_FSID = 2 // LAYOUT4_RET_REC_FSID
	LAYOUT4_RET_REC_ALL = 3 // LAYOUT4_RET_REC_ALL
	TH4_READ_SIZE = 0 // TH4_READ_SIZE
	TH4_WRITE_SIZE = 1 // TH4_WRITE_SIZE
	TH4_READ_IOSIZE = 2 // TH4_READ_IOSIZE
	TH4_WRITE_IOSIZE = 3 // TH4_WRITE_IOSIZE
	RET4_DURATION_INFINITE = 0xffffffffffffffff // RET4_DURATION_INFINITE
	FSCHARSET_CAP4_CONTAINS_NON_UTF8 = 0x1 // FSCHARSET_CAP4_CONTAINS_NON_UTF8
	FSCHARSET_CAP4_ALLOWS_ONLY_UTF8 = 0x2 // FSCHARSET_CAP4_ALLOWS_ONLY_UTF8
	...
	FATTR4_SUPPATTR_EXCLCREAT = 75 // FATTR4_SUPPATTR_EXCLCREAT
	...
	FATTR4_DIR_NOTIF_DELAY = 56 // FATTR4_DIR_NOTIF_DELAY
	FATTR4_DIRENT_NOTIF_DELAY = 57 // FATTR4_DIRENT_NOTIF_DELAY
	FATTR4_DACL = 58 // FATTR4_DACL
	FATTR4_SACL = 59 // FATTR4_SACL
	FATTR4_CHANGE_POLICY = 60 // FATTR4_CHANGE_POLICY
	FATTR4_FS_STATUS = 61 // FATTR4_FS_STATUS
	FATTR4_FS_LAYOUT_TYPES = 62 // FATTR4_FS_LAYOUT_TYPES
	FATTR4_LAYOUT_HINT = 63 // FATTR4_LAYOUT_HINT
	FATTR4_LAYOUT_TYPES = 64 // FATTR4_LAYOUT_TYPES
	FATTR4_LAYOUT_BLKSIZE = 65 // FATTR4_LAYOUT_BLKSIZE
	FATTR4_LAYOUT_ALIGNMENT = 66 // FATTR4_LAYOUT_ALIGNMENT
	FATTR4_FS_LOCATIONS_INFO = 67 // FATTR4_FS_LOCATIONS_INFO
	FATTR4_MDSTHRESHOLD = 68 // FATTR4_MDSTHRESHOLD
	FATTR4_RETENTION_GET = 69 // FATTR4_RETENTION_GET
	FATTR4_RETENTION_SET = 70 // FATTR4_RETENTION_SET
	FATTR4_RETENTEVT_GET = 71 // FATTR4_RETENTEVT_GET
	FATTR4_RETENTEVT_SET = 72 // FATTR4_RETENTEVT_SET
	FATTR4_RETENTION_HOLD = 73 // FATTR4_RETENTION_HOLD
	FATTR4_MODE_SET_MASKED = 74 // FATTR4_MODE_SET_MASKED
	FATTR4_FS_CHARSET_CAP = 76 // FATTR4_FS_CHARSET_CAP
	FSLI4BX_GFLAGS = 0 // FSLI4BX_GFLAGS
	FSLI4BX_TFLAGS = 1 // FSLI4BX_TFLAGS
	FSLI4BX_CLSIMUL = 2 // FSLI4BX_CLSIMUL
	FSLI4BX_CLHANDLE = 3 // FSLI4BX_CLHANDLE
	FSLI4BX_CLFILEID = 4 // FSLI4BX_CLFILEID
	FSLI4BX_CLWRITEVER = 5 // FSLI4BX_CLWRITEVER
	FSLI4BX_CLCHANGE = 6 // FSLI4BX_CLCHANGE
	FSLI4BX_CLREADDIR = 7 // FSLI4BX_CLREADDIR
	FSLI4BX_READRANK = 8 // FSLI4BX_READRANK
	FSLI4BX_WRITERANK = 9 // FSLI4BX_WRITERANK
	FSLI4BX_READORDER = 10 // FSLI4BX_READORDER
	FSLI4BX_WRITEORDER = 11 // FSLI4BX_WRITEORDER
	FSLI4GF_WRITABLE = 0x01 // FSLI4GF_WRITABLE
	FSLI4GF_CUR_REQ = 0x02 // FSLI4GF_CUR_REQ
	FSLI4GF_ABSENT = 0x04 // FSLI4GF_ABSENT
	FSLI4GF_GOING = 0x08 // FSLI4GF_GOING
	FSLI4GF_SPLIT = 0x10 // FSLI4GF_SPLIT
	FSLI4TF_RDMA = 0x01 // FSLI4TF_RDMA
	FSLI4IF_VAR_SUB = 0x00000001 // FSLI4IF_VAR_SUB
	NFL4_UFLG_MASK = 0x0000003F // NFL4_UFLG_MASK
	NFL4_UFLG_DENSE = 0x00000001 // NFL4_UFLG_DENSE
	NFL4_UFLG_COMMIT_THRU_MDS = 0x00000002 // NFL4_UFLG_COMMIT_THRU_MDS
	NFL4_UFLG_STRIPE_UNIT_SIZE_MASK = 0xFFFFFFC0 // NFL4_UFLG_STRIPE_UNIT_SIZE_MASK
	...
	OPEN4_SHARE_ACCESS_WANT_DELEG_MASK = 0xFF00 // OPEN4_SHARE_ACCESS_WANT_DELEG_MASK
	OPEN4_SHARE_ACCESS_WANT_NO_PREFERENCE = 0x0000 // OPEN4_SHARE_ACCESS_WANT_NO_PREFERENCE
	OPEN4_SHARE_ACCESS_WANT_READ_DELEG = 0x0100 // OPEN4_SHARE_ACCESS_WANT_READ_DELEG
	OPEN4_SHARE_ACCESS_WANT_WRITE_DELEG = 0x0200 // OPEN4_SHARE_ACCESS_WANT_WRITE_DELEG
	OPEN4_SHARE_ACCESS_WANT_ANY_DELEG = 0x0300 // OPEN4_SHARE_ACCESS_WANT_ANY_DELEG
	OPEN4_SHARE_ACCESS_WANT_NO_DELEG = 0x0400 // OPEN4_SHARE_ACCESS_WANT_NO_DELEG
	OPEN4_SHARE_ACCESS_WANT_CANCEL = 0x0500 // OPEN4_SHARE_ACCESS_WANT_CANCEL
	OPEN4_SHARE_ACCESS_WANT_SIGNAL_DELEG_WHEN_RESRC_AVAIL = 0x10000 // OPEN4_SHARE_ACCESS_WANT_SIGNAL_DELEG_WHEN_RESRC_AVAIL
	OPEN4_SHARE_ACCESS_WANT_PUSH_DELEG_WHEN_UNCONTENDED = 0x20000 // OPEN4_SHARE_ACCESS_WANT_PUSH_DELEG_WHEN_UNCONTENDED
	OPEN4_RESULT_CONFIRM = 0x00000002 // OPEN4_RESULT_CONFIRM
	OPEN4_RESULT_LOCKTYPE_POSIX = 0x00000004 // OPEN4_RESULT_LOCKTYPE_POSIX
	OPEN4_RESULT_PRESERVE_UNLINKED = 0x00000008 // OPEN4_RESULT_PRESERVE_UNLINKED
	OPEN4_RESULT_MAY_NOTIFY_LOCK = 0x00000020 // OPEN4_RESULT_MAY_NOTIFY_LOCK
	EXCHGID4_FLAG_SUPP_MOVED_REFER = 0x00000001 // EXCHGID4_FLAG_SUPP_MOVED_REFER
	EXCHGID4_FLAG_SUPP_MOVED_MIGR = 0x00000002 // EXCHGID4_FLAG_SUPP_MOVED_MIGR
	EXCHGID4_FLAG_BIND_PRINC_STATEID = 0x00000100 // EXCHGID4_FLAG_BIND_PRINC_STATEID
	EXCHGID4_FLAG_USE_NON_PNFS = 0x00010000 // EXCHGID4_FLAG_USE_NON_PNFS
	EXCHGID4_FLAG_USE_PNFS_MDS = 0x00020000 // EXCHGID4_FLAG_USE_PNFS_MDS
	EXCHGID4_FLAG_USE_PNFS_DS = 0x00040000 // EXCHGID4_FLAG_USE_PNFS_DS
	EXCHGID4_FLAG_MASK_PNFS = 0x00070000 // EXCHGID4_FLAG_MASK_PNFS
	EXCHGID4_FLAG_UPD_CONFIRMED_REC_A = 0x40000000 // EXCHGID4_FLAG_UPD_CONFIRMED_REC_A
	EXCHGID4_FLAG_CONFIRMED_R = 0x80000000 // EXCHGID4_FLAG_CONFIRMED_R
	CREATE_SESSION4_FLAG_PERSIST = 0x00000001 // CREATE_SESSION4_FLAG_PERSIST
	CREATE_SESSION4_FLAG_CONN_BACK_CHAN = 0x00000002 // CREATE_SESSION4_FLAG_CONN_BACK_CHAN
	CREATE_SESSION4_FLAG_CONN_RDMA = 0x00000004 // CREATE_SESSION4_FLAG_CONN_RDMA
	SEQ4_STATUS_CB_PATH_DOWN = 0x00000001 // SEQ4_STATUS_CB_PATH_DOWN
	SEQ4_STATUS_CB_GSS_CONTEXTS_EXPIRING = 0x00000002 // SEQ4_STATUS_CB_GSS_CONTEXTS_EXPIRING
	SEQ4_STATUS_CB_GSS_CONTEXTS_EXPIRED = 0x00000004 // SEQ4_STATUS_CB_GSS_CONTEXTS_EXPIRED
	SEQ4_STATUS_EXPIRED_ALL_STATE_REVOKED = 0x00000008 // SEQ4_STATUS_EXPIRED_ALL_STATE_REVOKED
	SEQ4_STATUS_EXPIRED_SOME_STATE_REVOKED = 0x00000010 // SEQ4_STATUS_EXPIRED_SOME_STATE_REVOKED
	SEQ4_STATUS_ADMIN_STATE_REVOKED = 0x00000020 // SEQ4_STATUS_ADMIN_STATE_REVOKED
	SEQ4_STATUS_RECALLABLE_STATE_REVOKED = 0x00000040 // SEQ4_STATUS_RECALLABLE_STATE_REVOKED
	SEQ4_STATUS_LEASE_MOVED = 0x00000080 // SEQ4_STATUS_LEASE_MOVED
	SEQ4_STATUS_RESTART_RECLAIM_NEEDED = 0x00000100 // SEQ4_STATUS_RESTART_RECLAIM_NEEDED
	SEQ4_STATUS_CB_PATH_DOWN_SESSION = 0x00000200 // SEQ4_STATUS_CB_PATH_DOWN_SESSION
	SEQ4_STATUS_BACKCHANNEL_FAULT = 0x00000400 // SEQ4_STATUS_BACKCHANNEL_FAULT
	SEQ4_STATUS_DEVID_CHANGED = 0x00000800 // SEQ4_STATUS_DEVID_CHANGED
	SEQ4_STATUS_DEVID_DELETED = 0x00001000 // SEQ4_STATUS_DEVID_DELETED
	...
	RCA4_TYPE_MASK_OTHER_LAYOUT_MIN = 12 // RCA4_TYPE_MASK_OTHER_LAYOUT_MIN
	RCA4_TYPE_MASK_OTHER_LAYOUT_MAX = 15 // RCA4_TYPE_MASK_OTHER_LAYOUT_MAX
...
type Sequenceid4 uint32 // sequenceid4
type Seqid4 uint32 // seqid4
type Sessionid4 [NFS4_SESSIONID_SIZE]byte // sessionid4
type Slotid4 uint32 // slotid4
type Utf8string []byte // utf8string
...
type Linktext4 Utf8strCs // linktext4
...
type Aclflag4 uint32 // aclflag4
type Deviceid4 [NFS4_DEVICEID4_SIZE]byte // deviceid4
type Threshold4ReadSize Length4 // threshold4_read_size
type Threshold4WriteSize Length4 // threshold4_write_size
type Threshold4ReadIosize Length4 // threshold4_read_iosize
type Threshold4WriteIosize Length4 // threshold4_write_iosize
type FsCharsetCap4 uint32 // fs_charset_cap4
...
type Fattr4Mimetype Utf8strCs // fattr4_mimetype
...
type Fattr4SuppattrExclcreat Bitmap4 // fattr4_suppattr_exclcreat
type Fattr4DirNotifDelay Nfstime4 // fattr4_dir_notif_delay
type Fattr4DirentNotifDelay Nfstime4 // fattr4_dirent_notif_delay
type Fattr4FsLayoutTypes []Layouttype4 // fattr4_fs_layout_types
type Fattr4FsStatus Fs4Status // fattr4_fs_status
type Fattr4FsCharsetCap FsCharsetCap4 // fattr4_fs_charset_cap
type Fattr4LayoutAlignment uint32 // fattr4_layout_alignment
type Fattr4LayoutBlksize uint32 // fattr4_layout_blksize
type Fattr4LayoutHint Layouthint4 // fattr4_layout_hint
type Fattr4LayoutTypes []Layouttype4 // fattr4_layout_types
...
type Fattr4RetentionHold uint64 // fattr4_retention_hold
...
type Layouttype4 int32 // layouttype4
type Layoutiomode4 int32 // layoutiomode4
type LayoutreturnType4 int32 // layoutreturn_type4
type Fs4StatusType int32 // fs4_status_type
type NfsLockType4 int32 // nfs_lock_type4
type SsvSubkey4 int32 // ssv_subkey4
type FilelayoutHintCare4 int32 // filelayout_hint_care4
...
type WhyNoDelegation4 int32 // why_no_delegation4
type RpcGssSvcT int32 // rpc_gss_svc_t
type StableHow4 int32 // stable_how4
type ChannelDirFromClient4 int32 // channel_dir_from_client4
type ChannelDirFromServer4 int32 // channel_dir_from_server4
type StateProtectHow4 int32 // state_protect_how4
type Gddrnf4Status int32 // gddrnf4_status
type SecinfoStyle4 int32 // secinfo_style4
type NfsOpnum4 int32 // nfs_opnum4
type LayoutrecallType4 int32 // layoutrecall_type4
type NotifyType4 int32 // notify_type4
type NotifyDeviceidType4 int32 // notify_deviceid_type4
...
type GssCbHandles4 struct { // gss_cb_handles4
	...
	GcbpHandleFromServer Gsshandle4T
	GcbpHandleFromClient Gsshandle4T
}
...
type StateProtectOps4 struct { // state_protect_ops4
	SpoMustEnforce Bitmap4
	SpoMustAllow Bitmap4
}
...
type SsvProtInfo4 struct { // ssv_prot_info4
	...
	SpiSsvLen uint32
	SpiWindow uint32
	SpiHandles []Gsshandle4T
}


type ExchangeID4resok struct { // EXCHANGE_ID4resok
	EirClientid Clientid4
	EirSequenceid Sequenceid4
	EirFlags uint32
...
type ChannelAttrs4 struct { // channel_attrs4
	CaHeaderpadsize Count4
	CaMaxrequestsize Count4
	CaMaxresponsesize Count4
	CaMaxresponsesizeCached Count4
	CaMaxoperations Count4
	CaMaxrequests Count4
	CaRdmaIrd []uint32
}


type CreateSession4args struct { // CREATE_SESSION4args
	CsaClientid Clientid4
	CsaSequence Sequenceid4
	CsaFlags uint32
...
type GetDirDelegation4args struct { // GET_DIR_DELEGATION4args
	...
	GddaNotificationTypes Bitmap4
	GddaChildAttrDelay AttrNotice4
	GddaDirAttrDelay AttrNotice4
	GddaChildAttributes Bitmap4
	GddaDirAttributes Bitmap4
}
...
type GetDirDelegation4resok struct { // GET_DIR_DELEGATION4resok
	...
	GddrNotification Bitmap4
	GddrChildAttributes Bitmap4
	GddrDirAttributes Bitmap4
}
...
type SEQUENCE4args struct { // SEQUENCE4args
	...
	SaSequenceid Sequenceid4
	SaSlotid Slotid4
	SaHighestSlotid Slotid4
	SaCachethis bool
}
...
type SEQUENCE4resok struct { // SEQUENCE4resok
	...
	SrSequenceid Sequenceid4
	SrSlotid Slotid4
	SrHighestSlotid Slotid4
	SrTargetHighestSlotid Slotid4
...
type CbRecallSlot4args struct { // CB_RECALL_SLOT4args
	RsaTargetHighestSlotid Slotid4
}
...
type CbSequence4args struct { // CB_SEQUENCE4args
	...
	CsaSequenceid Sequenceid4
	CsaSlotid Slotid4
	CsaHighestSlotid Slotid4
	CsaCachethis bool
...
type CbSequence4resok struct { // CB_SEQUENCE4resok
	CsrSessionid Sessionid4
	CsrSequenceid Sequenceid4
	CsrSlotid Slotid4
	CsrHighestSlotid Slotid4
	CsrTargetHighestSlotid Slotid4
}
...
type Layoutreturn4 struct {
	LrReturntype LayoutreturnType4 `xdr:"union"`
...
type Createtype4 struct {
	...
	Devdata  Specdata4  `xdr:"unioncase=3"` // Nf4blk
	Devdata  Specdata4  `xdr:"unioncase=4"` // Nf4chr
...
type Createhow4 struct {
	...
	Createattrs  Fattr4  `xdr:"unioncase=0"` // Unchecked4
	Createattrs  Fattr4  `xdr:"unioncase=1"` // Guarded4
...
type OpenNoneDelegation4 struct {
	OndWhy WhyNoDelegation4 `xdr:"union"`
...
type StateProtect4R struct {
	SprHow StateProtectHow4 `xdr:"union"`
	//    `xdr:"unioncase=0"` // None
...
type Newoffset4 struct {
	...
	NoOffset  Offset4  `xdr:"unioncase=TRUE"` // True
	//    `xdr:"unioncase=FALSE"` // False
}
...
type NfsArgop4 struct {
	...
	OpsecinfoNoName  SecinfoNoName4args  `xdr:"unioncase=52"` // Name
...
type Layoutrecall4 struct {
	LorRecalltype LayoutrecallType4 `xdr:"union"`
...
func Confirm (openstateid Stateid4, seqid Seqid4) (NfsArgop4) {
	return NfsArgop4{Argop:20, OpopenConfirm:OpenConfirm4args{ OpenStateid:openstateid, Seqid:seqid } }
}


func Downgrade (openstateid Stateid4, seqid Seqid4, shareaccess uint32, sharedeny uint32) (NfsArgop4) {
...
func Confirm (clientid Clientid4, setclientidconfirm Verifier4) (NfsArgop4) {
...
func Session (bctsasessid Sessionid4, bctsadir ChannelDirFromClient4, bctsauseconninrdmamode bool) (NfsArgop4) {
...
func Id (eiaclientowner ClientOwner4, eiaflags uint32, eiastateprotect StateProtect4A, eiaclientimplid []NfsImplID4) (NfsArgop4) {
...
func Session (csaclientid Clientid4, csasequence Sequenceid4, csaflags uint32, csaforechanattrs ChannelAttrs4, csabackchanattrs ChannelAttrs4, csacbprogram uint32, csasecparms []CallbackSecParms4) (NfsArgop4) {
...
func Session (dsasessionid Sessionid4) (NfsArgop4) {
...
func Delegation (gddasignaldelegavail bool, gddanotificationtypes Bitmap4, gddachildattrdelay AttrNotice4, gddadirattrdelay AttrNotice4, gddachildattributes Bitmap4, gddadirattributes Bitmap4) (NfsArgop4) {
...
func Getdeviceinfo (gdiadeviceid Deviceid4, gdialayouttype Layouttype4, gdiamaxcount Count4, gdianotifytypes Bitmap4) (NfsArgop4) {
...
func Getdevicelist (gdlalayouttype Layouttype4, gdlamaxdevices Count4, gdlacookie NfsCookie4, gdlacookieverf Verifier4) (NfsArgop4) {
...
func Layoutcommit (locaoffset Offset4, localength Length4, locareclaim bool, locastateid Stateid4, localastwriteoffset Newoffset4, locatimemodify Newtime4, localayoutupdate Layoutupdate4) (NfsArgop4) {
...
func Layoutget (logasignallayoutavail bool, logalayouttype Layouttype4, logaiomode Layoutiomode4, logaoffset Offset4, logalength Length4, logaminlength Length4, logastateid Stateid4, logamaxcount Count4) (NfsArgop4) {
...
func Layoutreturn (lorareclaim bool, loralayouttype Layouttype4, loraiomode Layoutiomode4, loralayoutreturn Layoutreturn4) (NfsArgop4) {
...
func Name () (NfsArgop4) {
	return NfsArgop4{Argop:52, OpsecinfoNoName:SecinfoNoName4args{  } }
}


func Sequence (sasessionid Sessionid4, sasequenceid Sequenceid4, saslotid Slotid4, sahighestslotid Slotid4, sacachethis bool) (NfsArgop4) {
